...
* [*t4n-live.sh*](#t4n-live) - The T4n OS live image generator for x86
* [*t4n-iso.sh*](#t4n-iso) - Wrapper script to generate bootable and installable live
  images for i686, x86_64, and aarch64.
* [*t4n-rootfs.sh*](#t4n-rootfs) - The Void Linux rootfs generator for all platforms
* [*t4n-platformfs.sh*](#t4nplatformfs) - The Void Linux filesystem tool to produce
...
[*t4n-iso.sh*](#t4n-iso). To generate a more basic live ISO
(which does not include things like `void-installer`), use [*t4n-live.sh*](#t4n-live).
...
Note that void-mklive/t4n-maker is not guaranteed to work on distributions other than Void
